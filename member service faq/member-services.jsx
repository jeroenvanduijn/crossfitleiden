    ...
    faqs: [
      {
        ...
        a: `<strong>Regular Group:</strong><br/>Base – 3x per week @ €135/maand<br/>Pro – 4x per week @ €159/maand<br/>Elite – 6x per week @ €169/maand<br/><br/><strong>Semi-Private (GetShredded):</strong><br/>Maandelijks – €450/maand (minimaal 2 maanden)<br/>6-maanden contract – €400/maand`,
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: `<strong>Ochtendgroep:</strong><br/>Maandelijks: €450/maand (3 maanden commitment bij start)<br/>6-maanden: €400/maand<br/><br/><strong>Avondgroep:</strong><br/>€700 voor een 8-weken cyclus (vast commitment)`,
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: `<strong>60 minuten:</strong><br/>1 sessie: €85<br/>10 sessies: €800<br/><br/><strong>30 minuten:</strong><br/>1 sessie: €45<br/>10 sessies: €400<br/><br/>Goal Review: gratis (inbegrepen bij je abonnement)`,
      },
      {
    ...
    faqs: [
      {
        ...
        a: `<strong>1. Kickstart Groepsprogramma</strong><br/>Hetzelfde programma als nieuwe leden volgen, op maat gemaakt. Investering: €200 voor 4 weken.<br/><br/><strong>2. 1-op-1 Voedingscoaching</strong><br/>Volledig gepersonaliseerd programma met een coach.<br/><br/><a href="https://kilo.gymleadmachine.com/widget/bookings/crossfitleiden/free-intro-nutrition" target="_blank" class="faq-link">→ Gratis voedingsintake boeken</a>`,
      },
      {
...
function CategoryCard({ category, index, onClick, isActive }) {
  return (
    <button
      onClick={onClick}
      style={{
...
function FAQItem({ faq, isOpen, onToggle, highlight, color }) {
  ...
  return (
    <div style={{
      ...
      <button
        ...
        onMouseEnter={(e) => e.currentTarget.parentElement.style.background = "#fafafa"}
...
function CategoryDetail({ category, searchQuery }) {
