...
export default function FitnessRealityCheck() {
  ...
  const handleAnswer = (optionIndex: number) => {
    ...
    setTimeout(() => {
      ...
      if (currentQuestion < currentSectionQuestions.length - 1) {
        ...
        setShowResult(true);
        track('Fitness Test Completed', { score: calculateScore() });
      }
  ...
  const restart = () => {
    ...
    setAnswers({});
    setShowResult(false);
    track('Fitness Test Restarted');
  };

  const handleStart = () => {
    setStarted(true);
    track('Fitness Test Started');
  };
        ...
        <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-6 py-12">
          <div className="max-w-xl w-full text-center">
            ...
            <p className="text-gray-500 mb-10 max-w-md mx-auto leading-relaxed">
              This short test shows you where you stand right now. And what's possible when you start training with the right guidance.
            </p>

            <div className="flex flex-wrap justify-center gap-6 mb-10 text-sm">
              <div className="flex items-center gap-2 text-gray-600 bg-gray-50 px-4 py-2 rounded-full">
                <span className="text-[#0CBABA]">⏱</span> 7-10 minutes
              </div>
              <div className="flex items-center gap-2 text-gray-600 bg-gray-50 px-4 py-2 rounded-full">
                <span className="text-[#F7CB15]">📊</span> 18 questions
              </div>
              <div className="flex items-center gap-2 text-gray-600 bg-gray-50 px-4 py-2 rounded-full">
                <span className="text-[#EF4C37]">🎯</span> Personal profile
              </div>
            </div>
          ...
          <div className="max-w-xl w-full">
              ...
              <div className="relative mb-8">
                <div className="w-36 h-36 mx-auto relative">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center">
                    ...
                    <span className="text-gray-400 text-sm">of 72</span>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-[#EF4C37] rounded-3xl p-8 text-center text-white">
              <h3 className="text-2xl font-bold mb-2">
                Your score shows where you are today.
              </h3>
              <p className="text-white/80 mb-6 text-lg">
                It doesn't define where you can go.
              </p>
              ...
              <a
                ...
                onClick={() => track('Fitness Test CTA Click', { score, level: result.level })}
              >
              ...
              <p className="text-white/70 text-sm">
                We'll look at your results together and show you exactly how to move forward.
                <br />No pressure. Just a clear plan.
              </p>
            </div>
  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden">
      ...
      <div className="absolute top-6 left-6 right-6 flex justify-between items-center text-sm">
        <span className="text-gray-400 font-medium">{questionNumber} of {totalQuestions}</span>
